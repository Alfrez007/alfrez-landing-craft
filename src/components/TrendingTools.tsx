...
const TrendingTools = () => {
  ...
  return <section id="tools" className="py-20 bg-cyan-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-green-300">
            Trending <span className="gradient-text text-blue-500">Tools</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {tools.map((tool, index) => <Card key={index} className="hover-lift border-0 elegant-shadow card-gradient">
              <CardHeader>
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 bg-primary/10 rounded-lg">
                    <tool.icon className="h-6 w-6 text-primary" />
                  </div>
                  {tool.trending && <span className="px-2 py-1 bg-accent/10 text-accent text-xs font-medium rounded-full">
                      Trending
                    </span>}
                </div>
              ...
              <CardContent>
                ...
                <Button variant="ghost" className="w-full justify-between p-0 h-auto bg-gray-50">
                  Try Now
